local mod = foundation.new_module("cat_plushies", "1.0.0")

core.register_node("cat_plushies:chat_roux", {
...
core.register_node("cat_plushies:chat_noir", {
...
core.register_node("cat_plushies:brown_bear", {
...
core.register_node("cat_plushies:polar_bear", {
...
core.register_node("cat_plushies:black_hamster", {
...
core.register_node("cat_plushies:poulpe", {
