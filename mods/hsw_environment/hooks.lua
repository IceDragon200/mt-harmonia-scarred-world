...
-- @spec.private handle_on_punch(
--   pos: Vector3,
--   node: NodeRef,
--   puncher: PlayerRef,
--   pointed_thing: PointedThing
-- ): void
local function handle_on_punch(pos, node, puncher, pointed_thing)
  minetest.log("action", puncher:get_player_name() .. " is punching node " .. node.name)
end

minetest.register_on_punchnode(handle_on_punch)
