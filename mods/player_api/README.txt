...
Imported and modified from the [Minetest Game](https://github.com/luanti-org/minetest_game) version for HSW.

Anyway, here is the original readme (minus the heading):
